...
func newTopic(db *gorm.DB, opts ...gen.DOOption) topic {
	...
	_topic.topicDo.UseModel(&orm_gen.Topic{})
...
type ITopicDo interface {
	...
	Unscoped() ITopicDo
	Create(values ...*orm_gen.Topic) error
	CreateInBatches(values []*orm_gen.Topic, batchSize int) error
	Save(values ...*orm_gen.Topic) error
	First() (*orm_gen.Topic, error)
	Take() (*orm_gen.Topic, error)
	Last() (*orm_gen.Topic, error)
	Find() ([]*orm_gen.Topic, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.Topic, err error)
	FindInBatches(result *[]*orm_gen.Topic, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*orm_gen.Topic) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*orm_gen.Topic, error)
	FirstOrCreate() (*orm_gen.Topic, error)
	FindByPage(offset int, limit int) (result []*orm_gen.Topic, count int64, err error)
...
func (t topicDo) Create(values ...*orm_gen.Topic) error {
	if len(values) == 0 {
		return nil
	}
...
func (t topicDo) CreateInBatches(values []*orm_gen.Topic, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t topicDo) Save(values ...*orm_gen.Topic) error {
	if len(values) == 0 {
		return nil
	}
...
func (t topicDo) First() (*orm_gen.Topic, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*orm_gen.Topic), nil
	}
}

func (t topicDo) Take() (*orm_gen.Topic, error) {
...
func (t topicDo) Last() (*orm_gen.Topic, error) {
...
func (t topicDo) Find() ([]*orm_gen.Topic, error) {
	result, err := t.DO.Find()
	return result.([]*orm_gen.Topic), err
}

func (t topicDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.Topic, err error) {
	buf := make([]*orm_gen.Topic, 0, batchSize)
...
func (t topicDo) FindInBatches(result *[]*orm_gen.Topic, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t topicDo) FirstOrInit() (*orm_gen.Topic, error) {
...
func (t topicDo) FirstOrCreate() (*orm_gen.Topic, error) {
...
func (t topicDo) FindByPage(offset int, limit int) (result []*orm_gen.Topic, count int64, err error) {
...
func (t topicDo) Delete(models ...*orm_gen.Topic) (result gen.ResultInfo, err error) {
