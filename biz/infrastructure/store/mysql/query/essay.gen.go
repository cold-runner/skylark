...
func newEssay(db *gorm.DB, opts ...gen.DOOption) essay {
	...
	_essay.essayDo.UseModel(&orm_gen.Essay{})
...
type IEssayDo interface {
	...
	Unscoped() IEssayDo
	Create(values ...*orm_gen.Essay) error
	CreateInBatches(values []*orm_gen.Essay, batchSize int) error
	Save(values ...*orm_gen.Essay) error
	First() (*orm_gen.Essay, error)
	Take() (*orm_gen.Essay, error)
	Last() (*orm_gen.Essay, error)
	Find() ([]*orm_gen.Essay, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.Essay, err error)
	FindInBatches(result *[]*orm_gen.Essay, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*orm_gen.Essay) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*orm_gen.Essay, error)
	FirstOrCreate() (*orm_gen.Essay, error)
	FindByPage(offset int, limit int) (result []*orm_gen.Essay, count int64, err error)
...
func (e essayDo) Create(values ...*orm_gen.Essay) error {
	if len(values) == 0 {
		return nil
	}
...
func (e essayDo) CreateInBatches(values []*orm_gen.Essay, batchSize int) error {
	return e.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (e essayDo) Save(values ...*orm_gen.Essay) error {
	if len(values) == 0 {
		return nil
	}
...
func (e essayDo) First() (*orm_gen.Essay, error) {
	if result, err := e.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*orm_gen.Essay), nil
	}
}

func (e essayDo) Take() (*orm_gen.Essay, error) {
...
func (e essayDo) Last() (*orm_gen.Essay, error) {
...
func (e essayDo) Find() ([]*orm_gen.Essay, error) {
	result, err := e.DO.Find()
	return result.([]*orm_gen.Essay), err
}

func (e essayDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.Essay, err error) {
	buf := make([]*orm_gen.Essay, 0, batchSize)
...
func (e essayDo) FindInBatches(result *[]*orm_gen.Essay, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (e essayDo) FirstOrInit() (*orm_gen.Essay, error) {
...
func (e essayDo) FirstOrCreate() (*orm_gen.Essay, error) {
...
func (e essayDo) FindByPage(offset int, limit int) (result []*orm_gen.Essay, count int64, err error) {
...
func (e essayDo) Delete(models ...*orm_gen.Essay) (result gen.ResultInfo, err error) {
