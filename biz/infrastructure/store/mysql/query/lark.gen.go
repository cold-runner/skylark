...
func newLark(db *gorm.DB, opts ...gen.DOOption) lark {
	...
	_lark.larkDo.UseModel(&orm_gen.Lark{})
...
type ILarkDo interface {
	...
	Unscoped() ILarkDo
	Create(values ...*orm_gen.Lark) error
	CreateInBatches(values []*orm_gen.Lark, batchSize int) error
	Save(values ...*orm_gen.Lark) error
	First() (*orm_gen.Lark, error)
	Take() (*orm_gen.Lark, error)
	Last() (*orm_gen.Lark, error)
	Find() ([]*orm_gen.Lark, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.Lark, err error)
	FindInBatches(result *[]*orm_gen.Lark, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*orm_gen.Lark) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*orm_gen.Lark, error)
	FirstOrCreate() (*orm_gen.Lark, error)
	FindByPage(offset int, limit int) (result []*orm_gen.Lark, count int64, err error)
...
func (l larkDo) Create(values ...*orm_gen.Lark) error {
	if len(values) == 0 {
		return nil
	}
...
func (l larkDo) CreateInBatches(values []*orm_gen.Lark, batchSize int) error {
	return l.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (l larkDo) Save(values ...*orm_gen.Lark) error {
	if len(values) == 0 {
		return nil
	}
...
func (l larkDo) First() (*orm_gen.Lark, error) {
	if result, err := l.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*orm_gen.Lark), nil
	}
}

func (l larkDo) Take() (*orm_gen.Lark, error) {
...
func (l larkDo) Last() (*orm_gen.Lark, error) {
...
func (l larkDo) Find() ([]*orm_gen.Lark, error) {
	result, err := l.DO.Find()
	return result.([]*orm_gen.Lark), err
}

func (l larkDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.Lark, err error) {
	buf := make([]*orm_gen.Lark, 0, batchSize)
...
func (l larkDo) FindInBatches(result *[]*orm_gen.Lark, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (l larkDo) FirstOrInit() (*orm_gen.Lark, error) {
...
func (l larkDo) FirstOrCreate() (*orm_gen.Lark, error) {
...
func (l larkDo) FindByPage(offset int, limit int) (result []*orm_gen.Lark, count int64, err error) {
...
func (l larkDo) Delete(models ...*orm_gen.Lark) (result gen.ResultInfo, err error) {
