...
func newDraft(db *gorm.DB, opts ...gen.DOOption) draft {
	...
	_draft.draftDo.UseModel(&orm_gen.Draft{})
...
type IDraftDo interface {
	...
	Unscoped() IDraftDo
	Create(values ...*orm_gen.Draft) error
	CreateInBatches(values []*orm_gen.Draft, batchSize int) error
	Save(values ...*orm_gen.Draft) error
	First() (*orm_gen.Draft, error)
	Take() (*orm_gen.Draft, error)
	Last() (*orm_gen.Draft, error)
	Find() ([]*orm_gen.Draft, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.Draft, err error)
	FindInBatches(result *[]*orm_gen.Draft, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*orm_gen.Draft) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*orm_gen.Draft, error)
	FirstOrCreate() (*orm_gen.Draft, error)
	FindByPage(offset int, limit int) (result []*orm_gen.Draft, count int64, err error)
...
func (d draftDo) Create(values ...*orm_gen.Draft) error {
	if len(values) == 0 {
		return nil
	}
...
func (d draftDo) CreateInBatches(values []*orm_gen.Draft, batchSize int) error {
	return d.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (d draftDo) Save(values ...*orm_gen.Draft) error {
	if len(values) == 0 {
		return nil
	}
...
func (d draftDo) First() (*orm_gen.Draft, error) {
	if result, err := d.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*orm_gen.Draft), nil
	}
}

func (d draftDo) Take() (*orm_gen.Draft, error) {
...
func (d draftDo) Last() (*orm_gen.Draft, error) {
...
func (d draftDo) Find() ([]*orm_gen.Draft, error) {
	result, err := d.DO.Find()
	return result.([]*orm_gen.Draft), err
}

func (d draftDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.Draft, err error) {
	buf := make([]*orm_gen.Draft, 0, batchSize)
...
func (d draftDo) FindInBatches(result *[]*orm_gen.Draft, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (d draftDo) FirstOrInit() (*orm_gen.Draft, error) {
...
func (d draftDo) FirstOrCreate() (*orm_gen.Draft, error) {
...
func (d draftDo) FindByPage(offset int, limit int) (result []*orm_gen.Draft, count int64, err error) {
...
func (d draftDo) Delete(models ...*orm_gen.Draft) (result gen.ResultInfo, err error) {
