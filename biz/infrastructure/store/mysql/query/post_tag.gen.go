...
func newPostTag(db *gorm.DB, opts ...gen.DOOption) postTag {
	...
	_postTag.postTagDo.UseModel(&orm_gen.PostTag{})
...
type IPostTagDo interface {
	...
	Unscoped() IPostTagDo
	Create(values ...*orm_gen.PostTag) error
	CreateInBatches(values []*orm_gen.PostTag, batchSize int) error
	Save(values ...*orm_gen.PostTag) error
	First() (*orm_gen.PostTag, error)
	Take() (*orm_gen.PostTag, error)
	Last() (*orm_gen.PostTag, error)
	Find() ([]*orm_gen.PostTag, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.PostTag, err error)
	FindInBatches(result *[]*orm_gen.PostTag, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*orm_gen.PostTag) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*orm_gen.PostTag, error)
	FirstOrCreate() (*orm_gen.PostTag, error)
	FindByPage(offset int, limit int) (result []*orm_gen.PostTag, count int64, err error)
...
func (p postTagDo) Create(values ...*orm_gen.PostTag) error {
	if len(values) == 0 {
		return nil
	}
...
func (p postTagDo) CreateInBatches(values []*orm_gen.PostTag, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p postTagDo) Save(values ...*orm_gen.PostTag) error {
	if len(values) == 0 {
		return nil
	}
...
func (p postTagDo) First() (*orm_gen.PostTag, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*orm_gen.PostTag), nil
	}
}

func (p postTagDo) Take() (*orm_gen.PostTag, error) {
...
func (p postTagDo) Last() (*orm_gen.PostTag, error) {
...
func (p postTagDo) Find() ([]*orm_gen.PostTag, error) {
	result, err := p.DO.Find()
	return result.([]*orm_gen.PostTag), err
}

func (p postTagDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.PostTag, err error) {
	buf := make([]*orm_gen.PostTag, 0, batchSize)
...
func (p postTagDo) FindInBatches(result *[]*orm_gen.PostTag, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p postTagDo) FirstOrInit() (*orm_gen.PostTag, error) {
...
func (p postTagDo) FirstOrCreate() (*orm_gen.PostTag, error) {
...
func (p postTagDo) FindByPage(offset int, limit int) (result []*orm_gen.PostTag, count int64, err error) {
...
func (p postTagDo) Delete(models ...*orm_gen.PostTag) (result gen.ResultInfo, err error) {
