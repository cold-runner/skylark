...
func newPostLike(db *gorm.DB, opts ...gen.DOOption) postLike {
	...
	_postLike.postLikeDo.UseModel(&orm_gen.PostLike{})
...
type IPostLikeDo interface {
	...
	Create(values ...*orm_gen.PostLike) error
	CreateInBatches(values []*orm_gen.PostLike, batchSize int) error
	Save(values ...*orm_gen.PostLike) error
	First() (*orm_gen.PostLike, error)
	Take() (*orm_gen.PostLike, error)
	Last() (*orm_gen.PostLike, error)
	Find() ([]*orm_gen.PostLike, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.PostLike, err error)
	FindInBatches(result *[]*orm_gen.PostLike, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*orm_gen.PostLike) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*orm_gen.PostLike, error)
	FirstOrCreate() (*orm_gen.PostLike, error)
	FindByPage(offset int, limit int) (result []*orm_gen.PostLike, count int64, err error)
...
func (p postLikeDo) Create(values ...*orm_gen.PostLike) error {
	if len(values) == 0 {
		return nil
	}
...
func (p postLikeDo) CreateInBatches(values []*orm_gen.PostLike, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p postLikeDo) Save(values ...*orm_gen.PostLike) error {
	if len(values) == 0 {
		return nil
	}
...
func (p postLikeDo) First() (*orm_gen.PostLike, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*orm_gen.PostLike), nil
	}
}

func (p postLikeDo) Take() (*orm_gen.PostLike, error) {
...
func (p postLikeDo) Last() (*orm_gen.PostLike, error) {
...
func (p postLikeDo) Find() ([]*orm_gen.PostLike, error) {
	result, err := p.DO.Find()
	return result.([]*orm_gen.PostLike), err
}

func (p postLikeDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.PostLike, err error) {
	buf := make([]*orm_gen.PostLike, 0, batchSize)
...
func (p postLikeDo) FindInBatches(result *[]*orm_gen.PostLike, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p postLikeDo) FirstOrInit() (*orm_gen.PostLike, error) {
...
func (p postLikeDo) FirstOrCreate() (*orm_gen.PostLike, error) {
...
func (p postLikeDo) FindByPage(offset int, limit int) (result []*orm_gen.PostLike, count int64, err error) {
...
func (p postLikeDo) Delete(models ...*orm_gen.PostLike) (result gen.ResultInfo, err error) {
