...
func newPlate(db *gorm.DB, opts ...gen.DOOption) plate {
	...
	_plate.plateDo.UseModel(&orm_gen.Plate{})
...
type IPlateDo interface {
	...
	Unscoped() IPlateDo
	Create(values ...*orm_gen.Plate) error
	CreateInBatches(values []*orm_gen.Plate, batchSize int) error
	Save(values ...*orm_gen.Plate) error
	First() (*orm_gen.Plate, error)
	Take() (*orm_gen.Plate, error)
	Last() (*orm_gen.Plate, error)
	Find() ([]*orm_gen.Plate, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.Plate, err error)
	FindInBatches(result *[]*orm_gen.Plate, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*orm_gen.Plate) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*orm_gen.Plate, error)
	FirstOrCreate() (*orm_gen.Plate, error)
	FindByPage(offset int, limit int) (result []*orm_gen.Plate, count int64, err error)
...
func (p plateDo) Create(values ...*orm_gen.Plate) error {
	if len(values) == 0 {
		return nil
	}
...
func (p plateDo) CreateInBatches(values []*orm_gen.Plate, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p plateDo) Save(values ...*orm_gen.Plate) error {
	if len(values) == 0 {
		return nil
	}
...
func (p plateDo) First() (*orm_gen.Plate, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*orm_gen.Plate), nil
	}
}

func (p plateDo) Take() (*orm_gen.Plate, error) {
...
func (p plateDo) Last() (*orm_gen.Plate, error) {
...
func (p plateDo) Find() ([]*orm_gen.Plate, error) {
	result, err := p.DO.Find()
	return result.([]*orm_gen.Plate), err
}

func (p plateDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.Plate, err error) {
	buf := make([]*orm_gen.Plate, 0, batchSize)
...
func (p plateDo) FindInBatches(result *[]*orm_gen.Plate, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p plateDo) FirstOrInit() (*orm_gen.Plate, error) {
...
func (p plateDo) FirstOrCreate() (*orm_gen.Plate, error) {
...
func (p plateDo) FindByPage(offset int, limit int) (result []*orm_gen.Plate, count int64, err error) {
...
func (p plateDo) Delete(models ...*orm_gen.Plate) (result gen.ResultInfo, err error) {
