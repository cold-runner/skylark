...
func newTopicLike(db *gorm.DB, opts ...gen.DOOption) topicLike {
	...
	_topicLike.topicLikeDo.UseModel(&orm_gen.TopicLike{})
...
type ITopicLikeDo interface {
	...
	Create(values ...*orm_gen.TopicLike) error
	CreateInBatches(values []*orm_gen.TopicLike, batchSize int) error
	Save(values ...*orm_gen.TopicLike) error
	First() (*orm_gen.TopicLike, error)
	Take() (*orm_gen.TopicLike, error)
	Last() (*orm_gen.TopicLike, error)
	Find() ([]*orm_gen.TopicLike, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.TopicLike, err error)
	FindInBatches(result *[]*orm_gen.TopicLike, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*orm_gen.TopicLike) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*orm_gen.TopicLike, error)
	FirstOrCreate() (*orm_gen.TopicLike, error)
	FindByPage(offset int, limit int) (result []*orm_gen.TopicLike, count int64, err error)
...
func (t topicLikeDo) Create(values ...*orm_gen.TopicLike) error {
	if len(values) == 0 {
		return nil
	}
...
func (t topicLikeDo) CreateInBatches(values []*orm_gen.TopicLike, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t topicLikeDo) Save(values ...*orm_gen.TopicLike) error {
	if len(values) == 0 {
		return nil
	}
...
func (t topicLikeDo) First() (*orm_gen.TopicLike, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*orm_gen.TopicLike), nil
	}
}

func (t topicLikeDo) Take() (*orm_gen.TopicLike, error) {
...
func (t topicLikeDo) Last() (*orm_gen.TopicLike, error) {
...
func (t topicLikeDo) Find() ([]*orm_gen.TopicLike, error) {
	result, err := t.DO.Find()
	return result.([]*orm_gen.TopicLike), err
}

func (t topicLikeDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.TopicLike, err error) {
	buf := make([]*orm_gen.TopicLike, 0, batchSize)
...
func (t topicLikeDo) FindInBatches(result *[]*orm_gen.TopicLike, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t topicLikeDo) FirstOrInit() (*orm_gen.TopicLike, error) {
...
func (t topicLikeDo) FirstOrCreate() (*orm_gen.TopicLike, error) {
...
func (t topicLikeDo) FindByPage(offset int, limit int) (result []*orm_gen.TopicLike, count int64, err error) {
...
func (t topicLikeDo) Delete(models ...*orm_gen.TopicLike) (result gen.ResultInfo, err error) {
