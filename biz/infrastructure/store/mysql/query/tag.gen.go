...
func newTag(db *gorm.DB, opts ...gen.DOOption) tag {
	...
	_tag.tagDo.UseModel(&orm_gen.Tag{})
...
type ITagDo interface {
	...
	Unscoped() ITagDo
	Create(values ...*orm_gen.Tag) error
	CreateInBatches(values []*orm_gen.Tag, batchSize int) error
	Save(values ...*orm_gen.Tag) error
	First() (*orm_gen.Tag, error)
	Take() (*orm_gen.Tag, error)
	Last() (*orm_gen.Tag, error)
	Find() ([]*orm_gen.Tag, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.Tag, err error)
	FindInBatches(result *[]*orm_gen.Tag, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*orm_gen.Tag) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*orm_gen.Tag, error)
	FirstOrCreate() (*orm_gen.Tag, error)
	FindByPage(offset int, limit int) (result []*orm_gen.Tag, count int64, err error)
...
func (t tagDo) Create(values ...*orm_gen.Tag) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tagDo) CreateInBatches(values []*orm_gen.Tag, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t tagDo) Save(values ...*orm_gen.Tag) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tagDo) First() (*orm_gen.Tag, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*orm_gen.Tag), nil
	}
}

func (t tagDo) Take() (*orm_gen.Tag, error) {
...
func (t tagDo) Last() (*orm_gen.Tag, error) {
...
func (t tagDo) Find() ([]*orm_gen.Tag, error) {
	result, err := t.DO.Find()
	return result.([]*orm_gen.Tag), err
}

func (t tagDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.Tag, err error) {
	buf := make([]*orm_gen.Tag, 0, batchSize)
...
func (t tagDo) FindInBatches(result *[]*orm_gen.Tag, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t tagDo) FirstOrInit() (*orm_gen.Tag, error) {
...
func (t tagDo) FirstOrCreate() (*orm_gen.Tag, error) {
...
func (t tagDo) FindByPage(offset int, limit int) (result []*orm_gen.Tag, count int64, err error) {
...
func (t tagDo) Delete(models ...*orm_gen.Tag) (result gen.ResultInfo, err error) {
