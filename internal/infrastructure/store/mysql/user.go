...
func (m *mysql) CreateLark(c context.Context, lark *model_gen.Lark) error {
...
// GetLark 利用高阶函数
func (m *mysql) GetLark(c context.Context, conds ...gen.Condition) (*model_gen.Lark, error) {
...
// GetLarkList 利用高阶函数
func (m *mysql) GetLarkList(c context.Context, conds ...gen.Condition) ([]*model_gen.Lark, error) {
...
func (m *mysql) UpdateLarkSelect(c context.Context, selectScopes []field.Expr, whereScopes []gen.Condition, lark *model_gen.Lark) error {
...
func (m *mysql) UpdateLarkOmit(c context.Context, omitScopes []field.Expr, whereScopes []gen.Condition, lark *model_gen.Lark) error {
