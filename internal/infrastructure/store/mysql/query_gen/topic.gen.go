...
func newTopic(db *gorm.DB, opts ...gen.DOOption) topic {
	...
	_topic.topicDo.UseModel(&model_gen.Topic{})

	tableName := _topic.topicDo.TableName()
	_topic.ALL = field.NewAsterisk(tableName)
	_topic.ID = field.NewField(tableName, "id")
...
type ITopicDo interface {
	...
	Unscoped() ITopicDo
	Create(values ...*model_gen.Topic) error
	CreateInBatches(values []*model_gen.Topic, batchSize int) error
	Save(values ...*model_gen.Topic) error
	First() (*model_gen.Topic, error)
	Take() (*model_gen.Topic, error)
	Last() (*model_gen.Topic, error)
	Find() ([]*model_gen.Topic, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_gen.Topic, err error)
	FindInBatches(result *[]*model_gen.Topic, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model_gen.Topic) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model_gen.Topic, error)
	FirstOrCreate() (*model_gen.Topic, error)
	FindByPage(offset int, limit int) (result []*model_gen.Topic, count int64, err error)
...
func (t topicDo) Create(values ...*model_gen.Topic) error {
	if len(values) == 0 {
		return nil
	}
...
func (t topicDo) CreateInBatches(values []*model_gen.Topic, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t topicDo) Save(values ...*model_gen.Topic) error {
	if len(values) == 0 {
		return nil
	}
...
func (t topicDo) First() (*model_gen.Topic, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model_gen.Topic), nil
	}
}

func (t topicDo) Take() (*model_gen.Topic, error) {
...
func (t topicDo) Last() (*model_gen.Topic, error) {
...
func (t topicDo) Find() ([]*model_gen.Topic, error) {
	result, err := t.DO.Find()
	return result.([]*model_gen.Topic), err
}

func (t topicDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_gen.Topic, err error) {
	buf := make([]*model_gen.Topic, 0, batchSize)
...
func (t topicDo) FindInBatches(result *[]*model_gen.Topic, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t topicDo) FirstOrInit() (*model_gen.Topic, error) {
...
func (t topicDo) FirstOrCreate() (*model_gen.Topic, error) {
...
func (t topicDo) FindByPage(offset int, limit int) (result []*model_gen.Topic, count int64, err error) {
...
func (t topicDo) Delete(models ...*model_gen.Topic) (result gen.ResultInfo, err error) {
