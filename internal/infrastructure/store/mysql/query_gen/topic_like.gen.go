...
func newTopicLike(db *gorm.DB, opts ...gen.DOOption) topicLike {
	...
	_topicLike.topicLikeDo.UseModel(&model_gen.TopicLike{})

	tableName := _topicLike.topicLikeDo.TableName()
	_topicLike.ALL = field.NewAsterisk(tableName)
	_topicLike.ID = field.NewField(tableName, "id")
	...
	_topicLike.TopicID = field.NewString(tableName, "topic_id")
	_topicLike.UserID = field.NewString(tableName, "user_id")
...
type topicLike struct {
	...
	TopicID   field.String // 话题id（考虑性能，不加外键）
...
func (t *topicLike) updateTableName(table string) *topicLike {
	...
	t.TopicID = field.NewString(table, "topic_id")
...
type ITopicLikeDo interface {
	...
	Create(values ...*model_gen.TopicLike) error
	CreateInBatches(values []*model_gen.TopicLike, batchSize int) error
	Save(values ...*model_gen.TopicLike) error
	First() (*model_gen.TopicLike, error)
	Take() (*model_gen.TopicLike, error)
	Last() (*model_gen.TopicLike, error)
	Find() ([]*model_gen.TopicLike, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_gen.TopicLike, err error)
	FindInBatches(result *[]*model_gen.TopicLike, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model_gen.TopicLike) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model_gen.TopicLike, error)
	FirstOrCreate() (*model_gen.TopicLike, error)
	FindByPage(offset int, limit int) (result []*model_gen.TopicLike, count int64, err error)
...
func (t topicLikeDo) Create(values ...*model_gen.TopicLike) error {
	if len(values) == 0 {
		return nil
	}
...
func (t topicLikeDo) CreateInBatches(values []*model_gen.TopicLike, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t topicLikeDo) Save(values ...*model_gen.TopicLike) error {
	if len(values) == 0 {
		return nil
	}
...
func (t topicLikeDo) First() (*model_gen.TopicLike, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model_gen.TopicLike), nil
	}
}

func (t topicLikeDo) Take() (*model_gen.TopicLike, error) {
...
func (t topicLikeDo) Last() (*model_gen.TopicLike, error) {
...
func (t topicLikeDo) Find() ([]*model_gen.TopicLike, error) {
	result, err := t.DO.Find()
	return result.([]*model_gen.TopicLike), err
}

func (t topicLikeDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_gen.TopicLike, err error) {
	buf := make([]*model_gen.TopicLike, 0, batchSize)
...
func (t topicLikeDo) FindInBatches(result *[]*model_gen.TopicLike, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t topicLikeDo) FirstOrInit() (*model_gen.TopicLike, error) {
...
func (t topicLikeDo) FirstOrCreate() (*model_gen.TopicLike, error) {
...
func (t topicLikeDo) FindByPage(offset int, limit int) (result []*model_gen.TopicLike, count int64, err error) {
...
func (t topicLikeDo) Delete(models ...*model_gen.TopicLike) (result gen.ResultInfo, err error) {
