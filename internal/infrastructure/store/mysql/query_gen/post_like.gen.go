...
func newPostLike(db *gorm.DB, opts ...gen.DOOption) postLike {
	...
	_postLike.postLikeDo.UseModel(&model_gen.PostLike{})
...
type IPostLikeDo interface {
	...
	Create(values ...*model_gen.PostLike) error
	CreateInBatches(values []*model_gen.PostLike, batchSize int) error
	Save(values ...*model_gen.PostLike) error
	First() (*model_gen.PostLike, error)
	Take() (*model_gen.PostLike, error)
	Last() (*model_gen.PostLike, error)
	Find() ([]*model_gen.PostLike, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_gen.PostLike, err error)
	FindInBatches(result *[]*model_gen.PostLike, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model_gen.PostLike) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model_gen.PostLike, error)
	FirstOrCreate() (*model_gen.PostLike, error)
	FindByPage(offset int, limit int) (result []*model_gen.PostLike, count int64, err error)
...
func (p postLikeDo) Create(values ...*model_gen.PostLike) error {
	if len(values) == 0 {
		return nil
	}
...
func (p postLikeDo) CreateInBatches(values []*model_gen.PostLike, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p postLikeDo) Save(values ...*model_gen.PostLike) error {
	if len(values) == 0 {
		return nil
	}
...
func (p postLikeDo) First() (*model_gen.PostLike, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model_gen.PostLike), nil
	}
}

func (p postLikeDo) Take() (*model_gen.PostLike, error) {
...
func (p postLikeDo) Last() (*model_gen.PostLike, error) {
...
func (p postLikeDo) Find() ([]*model_gen.PostLike, error) {
	result, err := p.DO.Find()
	return result.([]*model_gen.PostLike), err
}

func (p postLikeDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_gen.PostLike, err error) {
	buf := make([]*model_gen.PostLike, 0, batchSize)
...
func (p postLikeDo) FindInBatches(result *[]*model_gen.PostLike, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p postLikeDo) FirstOrInit() (*model_gen.PostLike, error) {
...
func (p postLikeDo) FirstOrCreate() (*model_gen.PostLike, error) {
...
func (p postLikeDo) FindByPage(offset int, limit int) (result []*model_gen.PostLike, count int64, err error) {
...
func (p postLikeDo) Delete(models ...*model_gen.PostLike) (result gen.ResultInfo, err error) {
