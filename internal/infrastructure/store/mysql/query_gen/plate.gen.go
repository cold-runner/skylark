...
func newPlate(db *gorm.DB, opts ...gen.DOOption) plate {
	...
	_plate.plateDo.UseModel(&model_gen.Plate{})

	tableName := _plate.plateDo.TableName()
	_plate.ALL = field.NewAsterisk(tableName)
	_plate.ID = field.NewField(tableName, "id")
...
type IPlateDo interface {
	...
	Unscoped() IPlateDo
	Create(values ...*model_gen.Plate) error
	CreateInBatches(values []*model_gen.Plate, batchSize int) error
	Save(values ...*model_gen.Plate) error
	First() (*model_gen.Plate, error)
	Take() (*model_gen.Plate, error)
	Last() (*model_gen.Plate, error)
	Find() ([]*model_gen.Plate, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_gen.Plate, err error)
	FindInBatches(result *[]*model_gen.Plate, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model_gen.Plate) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model_gen.Plate, error)
	FirstOrCreate() (*model_gen.Plate, error)
	FindByPage(offset int, limit int) (result []*model_gen.Plate, count int64, err error)
...
func (p plateDo) Create(values ...*model_gen.Plate) error {
	if len(values) == 0 {
		return nil
	}
...
func (p plateDo) CreateInBatches(values []*model_gen.Plate, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p plateDo) Save(values ...*model_gen.Plate) error {
	if len(values) == 0 {
		return nil
	}
...
func (p plateDo) First() (*model_gen.Plate, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model_gen.Plate), nil
	}
}

func (p plateDo) Take() (*model_gen.Plate, error) {
...
func (p plateDo) Last() (*model_gen.Plate, error) {
...
func (p plateDo) Find() ([]*model_gen.Plate, error) {
	result, err := p.DO.Find()
	return result.([]*model_gen.Plate), err
}

func (p plateDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_gen.Plate, err error) {
	buf := make([]*model_gen.Plate, 0, batchSize)
...
func (p plateDo) FindInBatches(result *[]*model_gen.Plate, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p plateDo) FirstOrInit() (*model_gen.Plate, error) {
...
func (p plateDo) FirstOrCreate() (*model_gen.Plate, error) {
...
func (p plateDo) FindByPage(offset int, limit int) (result []*model_gen.Plate, count int64, err error) {
...
func (p plateDo) Delete(models ...*model_gen.Plate) (result gen.ResultInfo, err error) {
