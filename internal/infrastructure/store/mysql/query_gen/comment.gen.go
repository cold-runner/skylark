...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.commentDo.UseModel(&model_gen.Comment{})

	tableName := _comment.commentDo.TableName()
	_comment.ALL = field.NewAsterisk(tableName)
	_comment.ID = field.NewField(tableName, "id")
...
type ICommentDo interface {
	...
	Unscoped() ICommentDo
	Create(values ...*model_gen.Comment) error
	CreateInBatches(values []*model_gen.Comment, batchSize int) error
	Save(values ...*model_gen.Comment) error
	First() (*model_gen.Comment, error)
	Take() (*model_gen.Comment, error)
	Last() (*model_gen.Comment, error)
	Find() ([]*model_gen.Comment, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_gen.Comment, err error)
	FindInBatches(result *[]*model_gen.Comment, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model_gen.Comment) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model_gen.Comment, error)
	FirstOrCreate() (*model_gen.Comment, error)
	FindByPage(offset int, limit int) (result []*model_gen.Comment, count int64, err error)
...
func (c commentDo) Create(values ...*model_gen.Comment) error {
	if len(values) == 0 {
		return nil
	}
...
func (c commentDo) CreateInBatches(values []*model_gen.Comment, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c commentDo) Save(values ...*model_gen.Comment) error {
	if len(values) == 0 {
		return nil
	}
...
func (c commentDo) First() (*model_gen.Comment, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model_gen.Comment), nil
	}
}

func (c commentDo) Take() (*model_gen.Comment, error) {
...
func (c commentDo) Last() (*model_gen.Comment, error) {
...
func (c commentDo) Find() ([]*model_gen.Comment, error) {
	result, err := c.DO.Find()
	return result.([]*model_gen.Comment), err
}

func (c commentDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_gen.Comment, err error) {
	buf := make([]*model_gen.Comment, 0, batchSize)
...
func (c commentDo) FindInBatches(result *[]*model_gen.Comment, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c commentDo) FirstOrInit() (*model_gen.Comment, error) {
...
func (c commentDo) FirstOrCreate() (*model_gen.Comment, error) {
...
func (c commentDo) FindByPage(offset int, limit int) (result []*model_gen.Comment, count int64, err error) {
...
func (c commentDo) Delete(models ...*model_gen.Comment) (result gen.ResultInfo, err error) {
