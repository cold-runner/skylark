...
func newTag(db *gorm.DB, opts ...gen.DOOption) tag {
	...
	_tag.tagDo.UseModel(&model_gen.Tag{})
	...
	_tag.CategorieID = field.NewString(tableName, "categorie_id")
...
type tag struct {
	...
	CategorieID field.String // 该标签隶属的归档
...
func (t *tag) updateTableName(table string) *tag {
	...
	t.CategorieID = field.NewString(table, "categorie_id")
...
func (t *tag) fillFieldMap() {
	...
	t.fieldMap["categorie_id"] = t.CategorieID
}
...
type ITagDo interface {
	...
	Unscoped() ITagDo
	Create(values ...*model_gen.Tag) error
	CreateInBatches(values []*model_gen.Tag, batchSize int) error
	Save(values ...*model_gen.Tag) error
	First() (*model_gen.Tag, error)
	Take() (*model_gen.Tag, error)
	Last() (*model_gen.Tag, error)
	Find() ([]*model_gen.Tag, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_gen.Tag, err error)
	FindInBatches(result *[]*model_gen.Tag, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model_gen.Tag) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model_gen.Tag, error)
	FirstOrCreate() (*model_gen.Tag, error)
	FindByPage(offset int, limit int) (result []*model_gen.Tag, count int64, err error)
...
func (t tagDo) Create(values ...*model_gen.Tag) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tagDo) CreateInBatches(values []*model_gen.Tag, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t tagDo) Save(values ...*model_gen.Tag) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tagDo) First() (*model_gen.Tag, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model_gen.Tag), nil
	}
}

func (t tagDo) Take() (*model_gen.Tag, error) {
...
func (t tagDo) Last() (*model_gen.Tag, error) {
...
func (t tagDo) Find() ([]*model_gen.Tag, error) {
	result, err := t.DO.Find()
	return result.([]*model_gen.Tag), err
}

func (t tagDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_gen.Tag, err error) {
	buf := make([]*model_gen.Tag, 0, batchSize)
...
func (t tagDo) FindInBatches(result *[]*model_gen.Tag, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t tagDo) FirstOrInit() (*model_gen.Tag, error) {
...
func (t tagDo) FirstOrCreate() (*model_gen.Tag, error) {
...
func (t tagDo) FindByPage(offset int, limit int) (result []*model_gen.Tag, count int64, err error) {
...
func (t tagDo) Delete(models ...*model_gen.Tag) (result gen.ResultInfo, err error) {
