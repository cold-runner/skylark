...
func newEssay(db *gorm.DB, opts ...gen.DOOption) essay {
	...
	_essay.essayDo.UseModel(&model_gen.Essay{})

	tableName := _essay.essayDo.TableName()
	_essay.ALL = field.NewAsterisk(tableName)
	_essay.ID = field.NewField(tableName, "id")
	...
	_essay.TopicID = field.NewString(tableName, "topic_id")
	_essay.UserID = field.NewString(tableName, "user_id")
...
type essay struct {
	...
	TopicID     field.String // 所属话题
	UserID      field.String // 随笔作者（考虑性能，不加外键）
...
type IEssayDo interface {
	...
	Unscoped() IEssayDo
	Create(values ...*model_gen.Essay) error
	CreateInBatches(values []*model_gen.Essay, batchSize int) error
	Save(values ...*model_gen.Essay) error
	First() (*model_gen.Essay, error)
	Take() (*model_gen.Essay, error)
	Last() (*model_gen.Essay, error)
	Find() ([]*model_gen.Essay, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_gen.Essay, err error)
	FindInBatches(result *[]*model_gen.Essay, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model_gen.Essay) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model_gen.Essay, error)
	FirstOrCreate() (*model_gen.Essay, error)
	FindByPage(offset int, limit int) (result []*model_gen.Essay, count int64, err error)
...
func (e essayDo) Create(values ...*model_gen.Essay) error {
	if len(values) == 0 {
		return nil
	}
...
func (e essayDo) CreateInBatches(values []*model_gen.Essay, batchSize int) error {
	return e.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (e essayDo) Save(values ...*model_gen.Essay) error {
	if len(values) == 0 {
		return nil
	}
...
func (e essayDo) First() (*model_gen.Essay, error) {
	if result, err := e.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model_gen.Essay), nil
	}
}

func (e essayDo) Take() (*model_gen.Essay, error) {
...
func (e essayDo) Last() (*model_gen.Essay, error) {
...
func (e essayDo) Find() ([]*model_gen.Essay, error) {
	result, err := e.DO.Find()
	return result.([]*model_gen.Essay), err
}

func (e essayDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_gen.Essay, err error) {
	buf := make([]*model_gen.Essay, 0, batchSize)
...
func (e essayDo) FindInBatches(result *[]*model_gen.Essay, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (e essayDo) FirstOrInit() (*model_gen.Essay, error) {
...
func (e essayDo) FirstOrCreate() (*model_gen.Essay, error) {
...
func (e essayDo) FindByPage(offset int, limit int) (result []*model_gen.Essay, count int64, err error) {
...
func (e essayDo) Delete(models ...*model_gen.Essay) (result gen.ResultInfo, err error) {
