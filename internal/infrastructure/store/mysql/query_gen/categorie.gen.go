...
func newCategorie(db *gorm.DB, opts ...gen.DOOption) categorie {
	...
	_categorie.categorieDo.UseModel(&model_gen.Categorie{})
...
type ICategorieDo interface {
	...
	Create(values ...*model_gen.Categorie) error
	CreateInBatches(values []*model_gen.Categorie, batchSize int) error
	Save(values ...*model_gen.Categorie) error
	First() (*model_gen.Categorie, error)
	Take() (*model_gen.Categorie, error)
	Last() (*model_gen.Categorie, error)
	Find() ([]*model_gen.Categorie, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_gen.Categorie, err error)
	FindInBatches(result *[]*model_gen.Categorie, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model_gen.Categorie) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model_gen.Categorie, error)
	FirstOrCreate() (*model_gen.Categorie, error)
	FindByPage(offset int, limit int) (result []*model_gen.Categorie, count int64, err error)
...
func (c categorieDo) Create(values ...*model_gen.Categorie) error {
	if len(values) == 0 {
		return nil
	}
...
func (c categorieDo) CreateInBatches(values []*model_gen.Categorie, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c categorieDo) Save(values ...*model_gen.Categorie) error {
	if len(values) == 0 {
		return nil
	}
...
func (c categorieDo) First() (*model_gen.Categorie, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model_gen.Categorie), nil
	}
}

func (c categorieDo) Take() (*model_gen.Categorie, error) {
...
func (c categorieDo) Last() (*model_gen.Categorie, error) {
...
func (c categorieDo) Find() ([]*model_gen.Categorie, error) {
	result, err := c.DO.Find()
	return result.([]*model_gen.Categorie), err
}

func (c categorieDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_gen.Categorie, err error) {
	buf := make([]*model_gen.Categorie, 0, batchSize)
...
func (c categorieDo) FindInBatches(result *[]*model_gen.Categorie, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c categorieDo) FirstOrInit() (*model_gen.Categorie, error) {
...
func (c categorieDo) FirstOrCreate() (*model_gen.Categorie, error) {
...
func (c categorieDo) FindByPage(offset int, limit int) (result []*model_gen.Categorie, count int64, err error) {
...
func (c categorieDo) Delete(models ...*model_gen.Categorie) (result gen.ResultInfo, err error) {
