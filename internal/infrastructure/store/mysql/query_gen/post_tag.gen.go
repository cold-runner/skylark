...
func newPostTag(db *gorm.DB, opts ...gen.DOOption) postTag {
	...
	_postTag.postTagDo.UseModel(&model_gen.PostTag{})
...
type IPostTagDo interface {
	...
	Unscoped() IPostTagDo
	Create(values ...*model_gen.PostTag) error
	CreateInBatches(values []*model_gen.PostTag, batchSize int) error
	Save(values ...*model_gen.PostTag) error
	First() (*model_gen.PostTag, error)
	Take() (*model_gen.PostTag, error)
	Last() (*model_gen.PostTag, error)
	Find() ([]*model_gen.PostTag, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_gen.PostTag, err error)
	FindInBatches(result *[]*model_gen.PostTag, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model_gen.PostTag) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model_gen.PostTag, error)
	FirstOrCreate() (*model_gen.PostTag, error)
	FindByPage(offset int, limit int) (result []*model_gen.PostTag, count int64, err error)
...
func (p postTagDo) Create(values ...*model_gen.PostTag) error {
	if len(values) == 0 {
		return nil
	}
...
func (p postTagDo) CreateInBatches(values []*model_gen.PostTag, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p postTagDo) Save(values ...*model_gen.PostTag) error {
	if len(values) == 0 {
		return nil
	}
...
func (p postTagDo) First() (*model_gen.PostTag, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model_gen.PostTag), nil
	}
}

func (p postTagDo) Take() (*model_gen.PostTag, error) {
...
func (p postTagDo) Last() (*model_gen.PostTag, error) {
...
func (p postTagDo) Find() ([]*model_gen.PostTag, error) {
	result, err := p.DO.Find()
	return result.([]*model_gen.PostTag), err
}

func (p postTagDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_gen.PostTag, err error) {
	buf := make([]*model_gen.PostTag, 0, batchSize)
...
func (p postTagDo) FindInBatches(result *[]*model_gen.PostTag, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p postTagDo) FirstOrInit() (*model_gen.PostTag, error) {
...
func (p postTagDo) FirstOrCreate() (*model_gen.PostTag, error) {
...
func (p postTagDo) FindByPage(offset int, limit int) (result []*model_gen.PostTag, count int64, err error) {
...
func (p postTagDo) Delete(models ...*model_gen.PostTag) (result gen.ResultInfo, err error) {
