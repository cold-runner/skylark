...
func newPost(db *gorm.DB, opts ...gen.DOOption) post {
	...
	_post.postDo.UseModel(&model_gen.Post{})
...
type IPostDo interface {
	...
	Unscoped() IPostDo
	Create(values ...*model_gen.Post) error
	CreateInBatches(values []*model_gen.Post, batchSize int) error
	Save(values ...*model_gen.Post) error
	First() (*model_gen.Post, error)
	Take() (*model_gen.Post, error)
	Last() (*model_gen.Post, error)
	Find() ([]*model_gen.Post, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_gen.Post, err error)
	FindInBatches(result *[]*model_gen.Post, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model_gen.Post) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model_gen.Post, error)
	FirstOrCreate() (*model_gen.Post, error)
	FindByPage(offset int, limit int) (result []*model_gen.Post, count int64, err error)
...
func (p postDo) Create(values ...*model_gen.Post) error {
	if len(values) == 0 {
		return nil
	}
...
func (p postDo) CreateInBatches(values []*model_gen.Post, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p postDo) Save(values ...*model_gen.Post) error {
	if len(values) == 0 {
		return nil
	}
...
func (p postDo) First() (*model_gen.Post, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model_gen.Post), nil
	}
}

func (p postDo) Take() (*model_gen.Post, error) {
...
func (p postDo) Last() (*model_gen.Post, error) {
...
func (p postDo) Find() ([]*model_gen.Post, error) {
	result, err := p.DO.Find()
	return result.([]*model_gen.Post), err
}

func (p postDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_gen.Post, err error) {
	buf := make([]*model_gen.Post, 0, batchSize)
...
func (p postDo) FindInBatches(result *[]*model_gen.Post, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p postDo) FirstOrInit() (*model_gen.Post, error) {
...
func (p postDo) FirstOrCreate() (*model_gen.Post, error) {
...
func (p postDo) FindByPage(offset int, limit int) (result []*model_gen.Post, count int64, err error) {
...
func (p postDo) Delete(models ...*model_gen.Post) (result gen.ResultInfo, err error) {
