...
type Post struct {
	...
	UserID      int64          `gorm:"column:user_id;type:bigint;not null;index:post_lark_id_fk,priority:1;comment:作者id" json:"user_id"`                  // 作者id
	...
	CategorieID int64          `gorm:"column:categorie_id;type:bigint;not null;index:post_categorie_id_fk,priority:1;comment:隶属哪个归档" json:"categorie_id"` // 隶属哪个归档
