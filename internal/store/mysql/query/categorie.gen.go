...
func newCategorie(db *gorm.DB, opts ...gen.DOOption) categorie {
	...
	_categorie.ID = field.NewInt64(tableName, "id")
	...
	_categorie.BackGroundURL = field.NewString(tableName, "back_ground_url")
	_categorie.Name = field.NewString(tableName, "name")
	_categorie.Rank = field.NewInt64(tableName, "rank")
	_categorie.PlateID = field.NewInt64(tableName, "plate_id")
...
func (c *categorie) updateTableName(table string) *categorie {
	...
	c.BackGroundURL = field.NewString(table, "back_ground_url")
	c.Name = field.NewString(table, "name")
	c.Rank = field.NewInt64(table, "rank")
	c.PlateID = field.NewInt64(table, "plate_id")
...
func (c *categorie) fillFieldMap() {
	...
	c.fieldMap["back_ground_url"] = c.BackGroundURL
