...
func newUserInteraction(db *gorm.DB, opts ...gen.DOOption) userInteraction {
	...
	_userInteraction.ID = field.NewInt64(tableName, "id")
	...
	_userInteraction.UserID = field.NewInt64(tableName, "user_id")
	_userInteraction.FollowedID = field.NewInt64(tableName, "followed_id")
...
type userInteraction struct {
	...
	UserID     field.Int64 // subject
	FollowedID field.Int64 // object
...
func (u *userInteraction) updateTableName(table string) *userInteraction {
	...
	u.FollowedID = field.NewInt64(table, "followed_id")
