...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.ReplyUserID = field.NewInt64(tableName, "reply_user_id")
...
type comment struct {
	...
	PostID      field.Int64  // 评论所属文章(考虑性能，不加约束)
	UserID      field.Int64  // 评论者id(考虑性能，不加约束)
	ReplyUserID field.Int64  // 回复评论(考虑性能，不加约束)
	ParentID    field.Int64  // 回复的父评论id
...
func (c *comment) updateTableName(table string) *comment {
	...
	c.ReplyUserID = field.NewInt64(table, "reply_user_id")
